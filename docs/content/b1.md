# Psylens — Bloque 1: El nacimiento de una ciencia
## Contenido aprobado y en producción

> Este archivo contiene TODO el contenido aprobado de los autores y tarjetas de revolución del Bloque 1 de la app: las tres capas completas (Superficie/Concepto/Fondo o Entrada/Profundidad para tarjetas), preguntas de quiz, y frases guardables. Organizado en el orden real de navegación.
>
> Contenido verificado directamente desde `constants/data.ts` mediante exportación programática (no transcripción manual) — texto íntegro, sin resumir ni acortar ningún párrafo. Verificado: sin menciones de metalenguaje ("bloque"/"sub-bloque") en ningún punto del texto.
>
> **Importante:** este archivo contiene SOLO los 5 autores reales del Bloque 1 de la app (Ebbinghaus, Fechner, Wundt, James, Thorndike) más sus 2 tarjetas de revolución. Watson y Skinner NO están aquí — aunque aparecían en el documento de referencia original "bloque1_contenido_revolucion.md", en la app real pertenecen al Bloque 3 (junto a Pavlov, Rogers, Maslow, Frankl). Su contenido vive en `b3-watson-skinner.md`.
>
...
> Posición en la app: `blockId: 'b1'`. Todo este bloque requiere premium (continúa el muro de pago que empieza en sb-0c).

---

## ÍNDICE RÁPIDO

**Sub-bloque 1A** — [rev-1a](#rev-1a) · [Ebbinghaus](#ebbinghaus) · [Fechner](#fechner) · [Wundt](#wundt)

**Sub-bloque 1B** — [rev-1b](#rev-1b) · [James](#james) · [Thorndike](#thorndike)

*(Watson y Skinner pertenecen a sb-1b en el documento de referencia original, pero en la app viven en Bloque 3 — ver `b3-watson-skinner.md`)*

---


### 🔷 rev-1a — Por primera vez, la mente entra al laboratorio
**Tipo:** Tarjeta de revolución | **Sub-bloque:** sb-1a
...
**Tipo:** Autor | **Sub-bloque:** sb-1a | **Fechas:** 1850–1909

#### SUPERFICIE

*¿Alguna vez estudiaste algo, lo entendiste bien, y días después sentiste que casi no quedaba nada? ¿O notaste que algunas cosas se te quedan grabadas y otras simplemente se van?*
...
*Lo que Ebbinghaus hizo fue algo que antes nadie había intentado: tratar la memoria como algo que puede medirse — como si fuera una distancia que puede calcularse o un tiempo que puede cronometrarse. Y al medirla, descubrió que tiene patrones propios que se repiten en todas las personas.*

#### FONDO

*¿Por qué importa alguien que memorizó sílabas sin sentido hace más de cien años?*
...
#### QUIZ
1. **Selección múltiple** — ¿Cómo sueles estudiar o aprender algo nuevo?
...
2. **Selección múltiple** — ¿Hay algo que intentaste aprender y se te olvidó antes de poder usarlo?
   - A) Sí, y ahora entiendo mejor por qué
   - B) Sí, y me frustraba no recordarlo
   - C) Sí, pero lo asociaba a otra cosa, no al olvido
   - D) Me pasa seguido con ciertas áreas

3. **Selección múltiple** — Si pudieras cambiar algo de cómo aprendes, ¿qué sería?
   - A) Distribuir más el estudio en el tiempo
   - B) Repasar en vez de releer desde cero
   - C) No exigirme recordar todo de una vez
   - D) Todas me parecen útiles


4. **Verdadero/Falso → FALSO** — Ebbinghaus descubrió que olvidamos de forma constante y pareja con el tiempo.
   *Explicación: El olvido ocurre muy rápido al principio y luego se vuelve más lento — eso es la curva del olvido.*

5. **Reflexión abierta** — ¿Hay algo que aprendiste hace tiempo y que te sorprende haber olvidado? ¿O algo que recuerdas con mucha claridad sin saber por qué?
...
**Tipo:** Autor | **Sub-bloque:** sb-1a | **Fechas:** 1801–1887

#### SUPERFICIE

*¿Alguna vez notaste que no es lo mismo añadir una vela a una habitación completamente oscura que añadirla a una ya iluminada? En la oscuridad, esa vela lo cambia todo. En la luz, casi no se nota.*
...
*Lo que Fechner hizo fue abrir una puerta que muchos creían cerrada: la posibilidad de estudiar lo que vivimos y sentimos con los mismos métodos que se usan para estudiar cualquier otra cosa en la naturaleza.*

#### FONDO

*¿Por qué importa alguien que pasó años pidiendo a personas que compararan pesos y luces?*
...
#### QUIZ
1. **Selección múltiple** — ¿Cuándo prestas más atención a algo?
...
2. **Selección múltiple** — ¿Hay algo en tu vida cotidiana que dejaste de valorar porque te acostumbraste a que estuviera?
   - A) Sí, en mis relaciones cercanas
   - B) Sí, en aspectos de mi salud o bienestar
   - C) Sí, en cosas pequeñas del día a día
   - D) Varias cosas — al leerlo me di cuenta

3. **Selección múltiple** — ¿Qué te ayudaría a volver a notar lo que das por sentado?
   - A) Hacer pausas más conscientes durante el día
   - B) Recordar momentos en que no lo tenía
   - C) Nombrarlo o agradecerlo de alguna forma
   - D) No lo sé todavía — es algo en lo que pensar


4. **Verdadero/Falso → VERDADERO** — Fechner demostró que lo que notamos depende de cuánto ya había, no solo del cambio en sí.
   *Explicación: Un vaso de agua añadido a un bidón no se nota, pero el mismo vaso en una botella casi vacía cambia todo.*

5. **Reflexión abierta** — ¿Hay algo cotidiano que dejaste de notar con el tiempo porque te acostumbraste?
...
### 👤 wundt — Wilhelm Wundt
**Tipo:** Autor | **Sub-bloque:** sb-1a | **Fechas:** 1832–1920

#### SUPERFICIE

*¿Alguna vez te preguntaste qué está pasando exactamente dentro de tu cabeza mientras lees esto — qué ocurre para que las palabras tengan sentido, para que algunas te llamen la atención y otras no, para que algunas te hagan sentir algo y otras pasen sin dejar rastro?*
...
*¿Y qué estudiaba exactamente en ese laboratorio?*
...
*Para Wundt, la psicología no era una rama de la filosofía ni de la medicina. Era una ciencia propia. Y ese laboratorio en Leipzig fue su prueba.*

#### FONDO

*¿Qué dejó Wundt que todavía importa?*
...
#### QUIZ
1. **Selección múltiple** — ¿Qué tan consciente eres de lo que ocurre dentro de ti mientras lo vives?
...
2. **Selección múltiple** — ¿Qué tan seguido te detienes a observar lo que estás sintiendo mientras lo estás viviendo?
   - A) Con frecuencia — es algo que practico
   - B) Poco — suelo procesarlo después
   - C) Me gustaría hacerlo más, pero me cuesta
   - D) Es algo que quiero desarrollar

3. **Selección múltiple** — Si pudieras tener más acceso a tu propia experiencia interior, ¿qué sería lo primero que querrías entender mejor?
   - A) Por qué ciertas situaciones me afectan más que otras
   - B) Qué hay detrás de mis reacciones automáticas
   - C) Cómo funciona mi atención — qué la atrae y qué la dispersa
   - D) Algo que todavía no sé nombrar bien


4. **Verdadero/Falso → VERDADERO** — Wundt creía que la experiencia consciente podía descomponerse en elementos básicos.
   *Explicación: Esa era su propuesta central — que la conciencia está formada por elementos simples que se combinan, como los ingredientes de un plato.*

5. **Reflexión abierta** — ¿Hay alguna experiencia tuya que, al intentar describirla con palabras, sientes que las palabras no alcanzan?
...
### 🔷 rev-1b — Si no puedes verlo, no puedes estudiarlo
**Tipo:** Tarjeta de revolución | **Sub-bloque:** sb-1b
...
### 👤 james — William James
**Tipo:** Autor | **Sub-bloque:** sb-1b | **Fechas:** 1842–1910

#### SUPERFICIE

*¿Alguna vez intentaste dejar de pensar — vaciarte la cabeza por completo — y descubriste que era imposible? Que en el momento en que creías haber llegado al silencio, ya había otro pensamiento entrando.*
...
*¿Y qué propuso James sobre cómo funciona la mente?*
...
*Y esa pregunta — ¿para qué sirve esto? — cambió completamente la dirección de la psicología americana.*

#### FONDO

*¿Qué dejó James que todavía usamos?*
...
#### QUIZ
1. **Selección múltiple** — ¿Cómo describes mejor tu experiencia mental en un día normal?
...
2. **Selección múltiple** — Si la conciencia es un flujo continuo, ¿qué crees que más lo interrumpe o lo enturbia en tu caso?
   - A) Las preocupaciones sobre el futuro
   - B) Los juicios sobre el pasado
   - C) La multitarea o el ruido externo
   - D) Una combinación de todo eso

3. **Selección múltiple** — ¿Hay algo que sabes que necesitas hacer pero que esperas a "sentirte listo" para empezar?
   - A) Sí, y James diría que la acción puede venir antes que el sentimiento
   - B) Sí — reconozco ese patrón en mí
   - C) A veces — depende del tema
   - D) Es algo que me resuena más de lo que quisiera


4. **Verdadero/Falso → FALSO** — Para William James, la conciencia es un estado fijo que puede analizarse en partes separadas.
   *Explicación: James propuso lo contrario — que la conciencia es un flujo continuo que no puede detenerse para analizarse sin perder lo más importante.*

5. **Reflexión abierta** — ¿Alguna vez intentaste "vaciarte la cabeza" completamente? ¿Qué pasó?
...
**Tipo:** Autor | **Sub-bloque:** sb-1b | **Fechas:** 1874–1949

#### SUPERFICIE

*¿Alguna vez notaste que cuando algo te sale bien tiendes a repetirlo, y cuando algo te sale mal tiendes a evitarlo — casi sin pensarlo?*
...
*Lo que Thorndike hizo fue abrir una puerta que la psicología todavía no ha terminado de explorar: la idea de que el comportamiento puede entenderse y modificarse estudiando sus consecuencias.*

#### FONDO

*¿Por qué importa alguien que puso gatos en cajas?*
...
#### QUIZ
1. **Selección múltiple** — ¿Reconoces en ti algún comportamiento que repites porque en algún momento te dio un buen resultado?
   - A) Sí, claramente
   - B) Puede ser, aunque no siempre lo noto en el momento
   - C) Probablemente, pero no lo había pensado así
   - D) No estoy seguro

2. **Selección múltiple** — ¿Hay algún hábito tuyo que crees que se instaló por las consecuencias que tuvo, aunque ya no te sirva igual?
   - A) Sí, en cómo busco aprobación o evito conflictos
   - B) Sí, en cómo respondo al estrés o la presión
   - C) Sí, en algún hábito cotidiano que persiste sin mucha razón
   - D) Posiblemente — es algo en lo que pensar

3. **Selección múltiple** — Si quisieras instalar un hábito nuevo, ¿qué cambiaría en tu enfoque sabiendo que el aprendizaje ocurre por consecuencias?
   - A) Buscaría hacer que la consecuencia positiva sea inmediata y visible
   - B) Reduciría la exigencia inicial para que el hábito tenga más oportunidades de "ganar"
   - C) Sería más paciente — sé que el cambio se acumula gradualmente
   - D) Todas cambian algo en cómo lo enfocaría


4. **Verdadero/Falso → FALSO** — Según Thorndike, aprendemos principalmente por comprensión consciente de lo que hacemos.
   *Explicación: Thorndike mostró que el aprendizaje ocurre por consecuencias — lo que produce un buen resultado tiende a repetirse, sin necesitar comprensión consciente.*

5. **Reflexión abierta** — ¿Hay algún hábito tuyo que ahora entiendes mejor sabiendo que aprendiste por las consecuencias que tuvo?
...
**Total:** 5 autores + 2 tarjetas de revolución = 7 entradas
**Nota:** Watson y Skinner pertenecen a Bloque 3 en la app — ver `b3-watson-skinner.md`
**Siguiente:** ver `b3-watson-skinner.md` para el contenido aprobado de Watson y Skinner
