# Psylens — Bloque 0: Contenido aprobado
## Las bases filosóficas de la psicología
...
```
BLOQUE 0 · LAS BASES FILOSÓFICAS
"Las preguntas que hicieron posible la psicología"
│
├── SUB-BLOQUE 0A — ¿Qué somos si no somos dioses?
│   ├── [Tarjeta de revolución] ✅
│   ├── 1. Los Presocráticos
│   ├── 2. Hipócrates
│   └── 3. Platón
│
├── SUB-BLOQUE 0B — La mente tiene partes — y no siempre se ponen de acuerdo
│   ├── [Tarjeta de revolución] ✅
│   ├── 4. Aristóteles
│   ├── 5. Filosofías Helenísticas
│   └── 6. Avicena
│
├── SUB-BLOQUE 0C — Pensar no es suficiente para entenderse
│   ├── [Tarjeta de revolución] ✅
│   ├── 7. Descartes
│   ├── 8. Spinoza
│   └── 9. Kant
│
└── SUB-BLOQUE 0D — Algo nos mueve antes de que lo decidamos
    ├── [Tarjeta de revolución] ✅
    ├── 10. Schopenhauer
    └── 11. Darwin
```
...
## TARJETA DE REVOLUCIÓN — Sub-bloque 0A
**¿Qué somos si no somos dioses?**
*Bloque 0 · Antigüedad · s. VI–IV a.C.*

### ENTRADA

Durante miles de años, las preguntas más importantes sobre los seres humanos tenían una sola dirección: hacia afuera. Hacia los dioses, hacia lo sobrenatural, hacia explicaciones que no venían de este mundo. ¿Por qué sufrimos? ¿Por qué algunos enloquecen y otros no? ¿Por qué somos como somos? La respuesta siempre era la misma: algo externo lo decidió.

Lo que estás a punto de ver es el momento en que eso cambió. Un grupo de pensadores en las costas de lo que hoy es Grecia decidió buscar las respuestas en otra parte — en el cuerpo, en la naturaleza, en el pensamiento mismo. Sin dioses de por medio.

Fue el primer paso. Y como todos los primeros pasos, fue imperfecto. Pero abrió una puerta que nunca volvió a cerrarse.
...
El primero preguntó si somos los mismos a lo largo del tiempo — si la persona que eras ayer es la misma que serás mañana, o si el cambio es tan constante que la continuidad es casi una ilusión. El segundo propuso algo que en su época fue escandaloso: que el sufrimiento mental no es castigo divino sino enfermedad, y que como tal puede estudiarse, tratarse y comprenderse. El tercero intentó mapear las distintas fuerzas que conviven dentro de cada persona — y propuso que vivir bien depende de aprender a conducirlas.
...
## 1. Los Presocráticos
**La gran pregunta sin respuesta sobrenatural**
*Bloque 0 · Antigüedad · s. VI–IV a.C.*
...
**Conexiones hacia adelante:** Heráclito → William James (B1) · Demócrito → neurociencia (B5)

---

## 2. Hipócrates
**El cerebro, no los dioses, es el origen de la mente**
*Bloque 0 · Antigua Grecia · 460–370 a.C.*
...
**Conexiones hacia adelante:** Hipócrates → neurociencia (B5) · Los cuatro humores → psicología de la personalidad

---

## 3. Platón
**¿Eres tus pensamientos, tus emociones, o algo más?**
*Bloque 0 · Antigua Grecia · 428–348 a.C.*
...
**Conexiones hacia adelante:** Platón → Descartes (el dualismo mente-cuerpo, B0) · Platón → Freud (el alma tripartita y la estructura de la psique, B2)

---

## TARJETA DE REVOLUCIÓN — Sub-bloque 0B
**La mente tiene partes — y no siempre se ponen de acuerdo**
*Bloque 0 · Antigua Grecia y Mediterráneo · s. IV a.C. – s. XI d.C.*

### ENTRADA

Los primeros pensadores abrieron la puerta. Los que vienen ahora entraron por ella — y fueron mucho más lejos.

Si la mente puede entenderse sin recurrir a los dioses, la siguiente pregunta es: ¿cómo está organizada por dentro? ¿Tiene partes? ¿Se puede elegir cómo sentirse, o las emociones simplemente ocurren? ¿Qué relación hay entre lo que le pasa al cuerpo y lo que experimenta la mente?

Esas preguntas no eran solo filosóficas. Eran preguntas sobre cómo vivir — sobre cómo manejar el miedo, el deseo, la tristeza, el impulso de hacer algo que sabes que no deberías hacer.

### PROFUNDIDAD

Los tres pensadores de este sub-bloque llegaron a respuestas muy distintas — y las tres siguen resonando hoy.

El primero propuso que las emociones no son interrupciones ni obstáculos. Son información — lecturas de lo que está pasando. Y si son lecturas, pueden ser más o menos acertadas. Y si pueden ser más o menos acertadas, pueden examinarse y cambiarse. El segundo fue más lejos: dijo que cuerpo y mente no son dos cosas separadas sino una sola, que no puede entenderse dividida en partes. El tercero tomó esa idea y la llevó a la práctica médica — documentando, por primera vez con rigor, que lo que sentimos emocionalmente tiene efectos físicos reales en el cuerpo.

Lo que los tres construyeron juntos es algo que la psicología tardó siglos en recuperar: la idea de que para entender a una persona hay que mirarla completa — no solo el cuerpo, no solo la mente, sino la conversación que ocurre entre los dos.

---

## 4. Aristóteles
**Las emociones no son el problema — son información**
*Bloque 0 · Antigua Grecia · 384–322 a.C.*
...
**Conexiones hacia adelante:** Aristóteles → Aaron Beck / terapia cognitiva (B4) · Aristóteles → Wundt, método experimental (B1) · Aristóteles → Avicena (B0)

---

## 5. Filosofías Helenísticas
**¿Puedes elegir cómo te sientes?**
*Bloque 0 · Mediterráneo · s. III a.C. – s. II d.C.*
...
Esa idea — que entre lo que pasa y lo que sientes hay siempre una interpretación, y que esa interpretación es donde tienes algo de control — es el fundamento filosófico de buena parte de lo que hoy llamamos psicoterapia, es decir, el trabajo con un profesional que ayuda a entender y transformar lo que ocurre en la mente. Una de esas formas de trabajo, la terapia cognitiva — que parte de la idea de que cambiar cómo pensamos puede cambiar cómo nos sentimos — la encontrarás más adelante en este recorrido. La cadena que va desde Epicteto hasta un consultorio de terapia hoy tiene más de dos mil años.
...
Y fue precisamente esa herencia — la idea de que la mente puede trabajar sobre sí misma, que el pensamiento puede transformar la experiencia — la que un médico y filósofo persa recogería siglos después, la combinaría con la medicina más avanzada de su época, y produciría algo que Europa tardaría siglos en comprender del todo.

**Conexiones hacia adelante:** Estoicismo → terapia cognitivo-conductual, Beck (B4) · Epicureísmo → psicología positiva (B5) · Escepticismo → terapias de tercera ola (B5)

---

## 6. Avicena
**La mente y el cuerpo como un solo sistema**
*Bloque 0 · Persia · 980–1037 d.C.*
...
Y mientras Avicena sintetizaba el conocimiento de su época desde Persia, en Europa algo estaba comenzando a moverse. Siglos después, un filósofo francés se haría una pregunta tan simple que parecía absurda — y en el intento de responderla, partiría el mundo en dos.

**Conexiones hacia adelante:** Avicena → medicina psicosomática (B5) · Avicena → Descartes, dualismo mente-cuerpo (B0)

---

## TARJETA DE REVOLUCIÓN — Sub-bloque 0C
**Pensar no es suficiente para entenderse**
*Bloque 0 · Europa · s. XVII – s. XVIII*

### ENTRADA

Los pensadores anteriores confiaban en el pensamiento. Si razonabas bien, si observabas con cuidado, podías llegar a entender la mente humana — y quizás entenderte a ti mismo. Esa confianza en la razón fue el motor de todo lo que viste antes.

Lo que estás a punto de ver es el momento en que esa confianza empezó a fisurarse.

En el espacio de dos siglos, tres filósofos europeos llegaron a conclusiones que sacudieron los cimientos de todo lo anterior. No propusieron respuestas nuevas. Hicieron algo más incómodo: pusieron en duda las herramientas con las que se hacían las preguntas.

### PROFUNDIDAD

El primero decidió dudar de absolutamente todo — y lo que encontró al final de esa duda fue una separación radical entre la mente y el cuerpo que todavía hoy estructura cómo pensamos sobre nosotros mismos. Esa separación abrió la puerta a la medicina científica moderna. Pero también cerró otra — la que los médicos anteriores habían mantenido abierta sobre la conexión entre lo emocional y lo físico.
...
El tercero fue más lejos todavía: propuso que hay un límite en lo que la razón puede conocer — incluido conocerse a uno mismo. Que siempre hay una capa más. Que la persona que crees ser hoy es una interpretación, no la verdad última sobre ti.

Cada uno dejó algo sin resolver. Y esas preguntas sin resolver son exactamente las que abren el siguiente sub-bloque.

---

## 7. Descartes
**El momento en que la mente y el cuerpo se separaron oficialmente**
*Bloque 0 · Francia · 1596–1650 d.C.*
...
**Conexiones hacia adelante:** Descartes → Spinoza (B0) · Descartes → Wundt, psicología experimental (B1) · Descartes → neurociencia actual (B5)

---

## 8. Spinoza
**Mente y cuerpo son lo mismo visto desde dos ángulos**
*Bloque 0 · Países Bajos · 1632–1677 d.C.*
...
**Conexiones hacia adelante:** Spinoza → Damasio, neurociencia de las emociones (B5) · Spinoza → terapias de aceptación (B5)

---

## 9. Kant
**¿Qué puedes realmente conocer de ti mismo?**
*Bloque 0 · Alemania · 1724–1804 d.C.*
...
**Conexiones hacia adelante:** Kant → límites del conocimiento (B0) · Kant → Freud, el inconsciente (B2) · Kant → Schopenhauer (B0)

---

## TARJETA DE REVOLUCIÓN — Sub-bloque 0D
**Algo nos mueve antes de que lo decidamos**
*Bloque 0 · Europa · s. XIX*
...
Los dos pensadores que cierran este bloque respondieron que sí. Y lo hicieron desde lugares completamente distintos — uno mirando adentro de la experiencia humana, el otro mirando afuera hacia la naturaleza entera.

Juntos construyen el puente más importante de todo el Bloque 0: el que va desde la filosofía hasta la ciencia.

### PROFUNDIDAD

El primero partió de donde el pensador anterior se había detenido — en los límites del conocimiento — y fue más lejos. Propuso que debajo de todo lo que razonamos y decidimos hay una fuerza que no elegimos ni controlamos: un impulso constante que nos mueve hacia el deseo, que nunca se satisface del todo, y que es la fuente de buena parte del sufrimiento humano. No lo llamó inconsciente. Pero Freud, décadas después, reconoció que había llegado exactamente ahí.

El segundo llegó desde un camino completamente distinto. Observando animales, plantas y fósiles durante años, propuso que somos el resultado de un proceso largo y sin dirección — y que nuestras emociones, nuestros instintos y nuestros comportamientos no son arbitrarios. Son respuestas que funcionaron. Soluciones que ayudaron a nuestros antepasados a sobrevivir en un mundo que no controlaban.

Los dos juntos dijeron algo que la psicología del siglo XX desarrollaría hasta sus últimas consecuencias: que hay partes de nosotros que no elegimos, que no vemos, y que nos mueven de todas formas. Con esto termina el Bloque 0. Lo que sigue ya no es filosofía — es ciencia.

---

## 10. Schopenhauer
**Hay algo dentro de ti que quiere, aunque tú no lo decidas**
*Bloque 0 · Alemania · 1788–1860 d.C.*
...
**Conexiones hacia adelante:** Schopenhauer → Freud, el inconsciente (B2) · Schopenhauer → budismo y atención plena (B5) · Schopenhauer → Darwin (B0)

---

## 11. Darwin
**No somos el centro — somos el resultado**
*Bloque 0 · Inglaterra · 1809–1882 d.C.*
...
*¿Por qué Darwin cierra este bloque?*

Porque lo que propuso no fue solo una teoría sobre los animales — fue una nueva forma de hacer preguntas sobre la mente humana. Y esa nueva forma de preguntar es exactamente lo que abre el siguiente bloque.
...
**Conexiones hacia adelante:** Darwin → William James, funcionalismo (B1) · Darwin → Freud, bases evolutivas del inconsciente (B2) · Darwin → psicología evolutiva (B5)
