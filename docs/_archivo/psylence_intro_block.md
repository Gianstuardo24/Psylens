# Psylence — Bloque de Introducción
## Contenido completo listo para integrar a constants/data.ts
...
```
BLOQUE · INTRODUCCIÓN
"Antes de empezar, entiende por qué estás aquí"

├── Intro 1 — El origen de la pregunta
│   2 capas: Entrada + Profundidad
│
...
└── Intro 4 — Así funciona cada capa
    3 capas: Superficie + Concepto + Fondo
    Cierre: "Ya sabes por qué estás aquí. Ahora comienza tu propio camino."
```

**Notas de implementación:**
- Intros 1, 2 y 3 tienen 2 capas (Entrada + Profundidad), no 3
- Intro 4 tiene 3 capas (Superficie + Concepto + Fondo)
- El bloque completo debe terminarse para desbloquear el Bloque 0
- Sin portrait individual — usar SVG abstracto o ilustración
...
## Intro 2 — Qué es y qué no es la psicología
*Desmonta mitos, define el campo honestamente*
...
*Eso es exactamente lo que Psylence intenta hacer: darte más lentes.*

---

## Intro 3 — Por qué este camino tiene este orden
*Por qué Aristóteles viene antes que Beck*
...
## Intro 4 — Así funciona cada capa
*El usuario reconoce lo que está a punto de vivir*
...
## Notas para implementación en código

### Estructura de datos sugerida para constants/data.ts

```typescript
// Nuevo bloque de introducción — va ANTES de b0
{
  id: 'intro',
  name: 'Introducción',
...
// Autores de introducción
{
  ...
  dates: '3000–500 a.C.',
  blockId: 'intro',
  layerType: 'two', // Entrada + Profundidad (no las 3 capas estándar)
  surface: { ... },  // usar como "Entrada"
  concept: { ... },  // usar como "Profundidad"
  // sin fondo
}

// Intro 4 usa las 3 capas estándar
{
  id: 'intro-4',
...
- El bloque 'intro' se activa inmediatamente al terminar el onboarding
- b0 se desbloquea solo cuando intro-1, intro-2, intro-3 e intro-4 están completos
- Las capas dentro de cada intro se desbloquean en orden
