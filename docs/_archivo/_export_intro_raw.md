...
**Type:** intro | **LayerType:** two | **Dates:** 3000–500 a.C.
...
Closing: Lo interesante no es que eso haya ocurrido. Lo interesante es que nunca dejó de ocurrir.
...
Closing: ¿Hay algo sobre ti mismo o sobre los demás que siempre quisiste entender mejor? Ese es exactamente el tipo de pregunta que este recorrido existe para acompañar.

---

## intro-2 — Qué es y qué no es la psicología
**Type:** intro | **LayerType:** two | **Dates:** —
...
Closing: Lo que encontrarás aquí no es la verdad sobre la mente humana. Es algo mejor.
...
Closing: Eso es exactamente lo que Psylens intenta hacer: darte más lentes.
...
Closing: Cada autor respondió a alguien que vino antes. Entender ese hilo hace que cada idea tenga más peso.
...
Closing: El recorrido no termina con una respuesta definitiva. Termina con una forma más clara de seguir preguntando.

---

## intro-4 — Así funciona cada capa
**Type:** intro | **LayerType:** three | **Dates:** —
...
Closing: Es la puerta de entrada a cada idea. Y todas las puertas de este recorrido están abiertas.
...
Closing: El Concepto existe para darte ese segundo nivel. El que convierte la intuición en comprensión.
...
Closing: Ya sabes por qué estás aquí. Ahora comienza tu propio camino.
