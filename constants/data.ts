...
export const authors = [

  {
    ...
    concept: {
      ...
      text: `Lo que Mesopotamia y Egipto tenían — y que a veces la psicología moderna olvida — era una comprensión simple pero poderosa: el sufrimiento psicológico es real, merece atención, y no hay que enfrentarlo solo.\n\nEl especialista mesopotámico que atendía a alguien en crisis no le decía que estaba simulando ni que era débil. Identificaba lo que ocurría, le daba un nombre y proponía algo concreto. La estructura era: síntoma — especialista — procedimiento. Eso, en su forma más básica, es exactamente lo que sigue ocurriendo hoy en cualquier consulta de psicología o psiquiatría.\n\nSiglos después, el psiquiatra Jerome Frank estudió culturas curativas de todo el mundo y encontró algo sorprendente: todas, sin excepción, compartían cuatro elementos. Una relación con alguien percibido como sanador (el curandero, el chamán, el sacerdote, etcétera). Un espacio que la comunidad reconoce como lugar legítimo para sanar (un templo, una consulta, una choza ceremonial). Una explicación que da sentido al sufrimiento (una teoría, una historia, un mito, etcétera). Y un procedimiento que tanto el sanador como quien sufre creen que puede ayudar (el método usado: un ritual, el consumo de alguna sustancia, un mantra, etcétera).\n\nMesopotamia tenía los cuatro. La psicoterapia contemporánea también los tiene (terapeuta, consulta, enfoques teóricos y metodologías particulares). La forma cambió. La estructura, no.`,
...

  {
    ...
    concept: {
      question: '¿Por qué la psicología no tiene una sola respuesta?',
...
export const revolutionCards = [
  {
    ...
    surface: {
      question: '',
      text: 'Durante miles de años, las preguntas más importantes sobre los seres humanos tenían una sola dirección: hacia afuera. Hacia los dioses, hacia lo sobrenatural.\n\nLo que estás a punto de ver es el momento en que eso cambió — un grupo de pensadores decidió buscar las respuestas en el cuerpo, en la naturaleza, en el pensamiento mismo.',
      closingLine: '',
    },
    concept: {
      question: '',
  ...
  },
  {
    ...
    surface: {
      question: '',
      text: 'Durante siglos, la razón fue la herramienta más confiable para entender la mente humana. Bastaba con razonar bien y observar con cuidado para llegar a comprenderla. Esa confianza en la razón fue el motor de todo lo que viste antes. Lo que estás a punto de ver es el momento en que esa confianza empezó a fisurarse.',
      closingLine: '',
    },
    concept: {
      question: '',
  ...
  },
  {
    ...
    surface: {
      question: '',
      text: 'Durante más de dos mil años, las preguntas sobre la mente humana vinieron de la filosofía. Nadie había medido cuánto tarda la mente en reaccionar ante algo, ni cuánto recuerda una persona después de un día o una semana, y tampoco habían intentado poner un número a la intensidad de lo que sentimos. Todo eso estaba a punto de cambiar.',
      closingLine: '',
    },
    concept: {
      question: '',
